...
fun ProfileScreenContent(
    ...
    Surface(modifier = Modifier.fillMaxSize()) {
        BoxWithConstraints(modifier = Modifier.fillMaxSize()) {
            ...
            // UBAH ANGKA INI kalau mau lebih rapat / lebih lega
            val horizontalPadding = if (maxWidth >= 720.dp) 28.dp else 20.dp
            val topPadding = if (maxWidth >= 720.dp) 28.dp else 24.dp
            val bottomPadding = if (maxWidth >= 720.dp) 28.dp else 24.dp
            val spacing = if (isWideLayout) 20.dp else 16.dp

            val columnWidth = (maxWidth - horizontalPadding * 2 - spacing) / 2
